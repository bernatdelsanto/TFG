...
/*
Custom viewholder for the parent of the expandable list
 */
...
/*
Custom viewholder for the child of the expandable list
 */
...
/*
Adapter that links Expandable RecyclerView with data using ViewHolders
 */
...
//inflate child view
    ...
    /*
    binding returns the child holder and the group that contains the data. this part creates the display depending on the permissions of the user to edit the list.
     */
    ...
    /*
        binding returns the parent holder and the group that contains the data. this part creates the display depending on the permissions of the user to edit the list.
         */
    @Override
