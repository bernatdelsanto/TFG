...
public class DiscoverFragment extends Fragment implements OnMapReadyCallback, AddPlaceDialogFragment.OnInputSelected {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addPlaceFloatingButton = view.findViewById(R.id.addPlaceButton); //Initially invisible, it shows then a place is focused by searching
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        map = googleMap;
        if (LOCATION_PERMISSION) { //Custom location permission logic is implemented
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            if (currentLocation != null) {
                                moveCamera(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()), DEFAULT_ZOOM); //On set map, focus the user's location
                            }
    ...
    public void sendInput(ArrayList<String> listsIds) {
        if (focusedPlace != null) {
            ...
            for (String s : listsIds) {
                GeoFire geoFire = new GeoFire(databaseReference.child(s)); //Saving data to Firebase using geofire.
    ...
    /*
    Geolocate by String name of the establishment
     */
    ...
    /*
    Only activity requested is PlaceAutocomplete. Asynchronously focusing on the place result.
     */
    @Override
